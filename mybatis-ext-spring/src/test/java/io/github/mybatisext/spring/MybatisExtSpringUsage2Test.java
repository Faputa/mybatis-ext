...
public class MybatisExtSpringUsage2Test {

	@Test
	public void test() {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:applicationContextUsage2.xml");
