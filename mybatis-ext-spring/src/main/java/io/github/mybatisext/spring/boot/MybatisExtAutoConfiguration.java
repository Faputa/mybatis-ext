...
public class MybatisExtAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    ExtContext extContext(MybatisExtProperties properties, DialectSelector dialectSelector) {
    ...
    @Bean
    @ConditionalOnMissingBean
    MapperMethodValidator mapperMethodValidator(Map<String, SqlSessionFactory> sqlSessionFactoryMap) {
