...
public abstract class BaseTemplateDialect extends BaseDialect {

    protected abstract String buildUpdate(TableInfo tableInfo, List<PropertyInfo> selectItems, Variable parameter, List<JoinTableInfo> joinTableInfos, Condition where, boolean batch, boolean join, boolean ignoreNull);

    protected abstract String buildDelete(TableInfo tableInfo, Variable parameter, List<JoinTableInfo> joinTableInfos, Condition where, boolean batch, boolean join);
