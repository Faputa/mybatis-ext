...
public class ExtEnhancer {
    ...
    private MappedStatement buildMappedStatement(String id, Class<?> mapperClass, String methodName, boolean writeConfiguration) {
        if (isNotEnhancedMapper(mapperClass)) {
            return null;
        }
        ...
        return mappedStatementHelper.build(id, tableType, methods, returnType, writeConfiguration);
    }
